...
class xBDS12Metrics:
    ...
    Following the xView2 challenge, the final score is a combination of localization and damage F1 scores:
    ...
    def __init__(
        ...
        dmg_classes_names: list | None = None,
        ignore_index: int = 99,
        ...
        if not localization_only:
            ...
            self.dmg_classes_names = dmg_classes_names if dmg_classes_names is not None else ["intact", "damaged"]
        self.reset()
    ...
    def compute(self) -> dict:
        ...
        f1_final = 0.3 * f1_loc + 0.7 * f1_dmg  # from xBD official metric
